...
- **Partidas por tipo** — letras 3D, recorte de acrílico, bastidor, caja de luz o captura manual, cada una con su catálogo de materiales y tarifas.
- **Cotizar con IA** — analiza un JPG o PDF del proyecto y propone las partidas.
...
- **Autorización** — flujo de vendedor a autorizador; el precio se bloquea al solicitar autorización.
- **PDF de cotización** con el logotipo, el desglose de partidas, IVA y anticipo sugerido.
- **Registrar venta** — anticipo, comisión, estatus y saldo pendiente.
- **Historial** de cotizaciones guardado en el propio dispositivo.
