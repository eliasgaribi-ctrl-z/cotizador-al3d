...
- **PDF de cotización** con el logotipo, el desglose de partidas, IVA, descuento autorizado y anticipo sugerido. Las partidas se reparten por hoja: antes, pasando de unas veinte, la tabla crecía más que la hoja carta, se partía en dos y la primera se quedaba sin el pie con el vendedor, el taller y el WhatsApp.
