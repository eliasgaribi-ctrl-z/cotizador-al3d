/* ============================================================================
   ...
   Eso es correcto para UN archivo. Es fatal para veinte. La plataforma son 32 módulos ES que
...
function revalidar(req) {
  /* Una sola revalidación por vuelta: la plataforma pide 32 módulos al arrancar y no tiene
