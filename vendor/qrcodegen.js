/* QR Code generator library — Project Nayuki (MIT). https://www.nayuki.io/page/qr-code-generator-library
   Copiado de github.com/nayuki/QR-Code-generator, typescript-javascript/qrcodegen.ts en el commit
   3c6d0b3cefb4e049dc337e82237c9644399716a8, y pasado a JavaScript con
   `module.stripTypeScriptTypes(src, {mode:'transform'})` de Node 24 —solo quita los tipos, no cambia
   una línea de lógica—. Es un guion clásico: deja `qrcodegen` en el ámbito global. La licencia
   completa va en la cabecera de abajo y en vendor/QRCODEGEN-LICENSE.txt. */
"use strict";
(function(qrcodegen) {
    class QrCode {
        version;
